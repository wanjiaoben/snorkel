...
| 优先级 | 任务 | 备注 |
|--------|------|------|
| 高 | Wan 审核 M0724-20 FAQ 事实 TODO | 确认现行价格与包含项、接送范围/费用、准确点位、季节/水温、不会游泳政策、年龄限制、天气取消/退款条款 |
...
- M0724-20 FAQ 中价格、资格与安全类信息在 Wan 确认前必须保留 TODO，不得将旧页面承诺直接复制进 FAQPage JSON-LD。
